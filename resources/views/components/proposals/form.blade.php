        ...
        <form class="space-y-6" wire:submit="save">
            ...
            <div class="flex gap-4">
                <div class="w-2/3 gap-2 flex flex-col">
                    ...
                    @error('email') 
                        <span class="text-red-500 font-semibold mt-1 text-sm">{{ $message }}</span> 
                    @enderror
                </div>
                <div class="w-1/3 gap-2 flex flex-col">
                    ...
                    <div class="flex" x-data="{ hours: @entangle('hours') }">
                        <button type="button" class="bg-[#1E1E2C] hover:bg-[#313145] transition duration-300 ease-in-out text-[#C3C3D1] py-2 px-3 text-3xl" @click="if(hours > 1)hours--">-</button>
